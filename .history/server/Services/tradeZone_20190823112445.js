...
const methods = {
   ...
   //     console.log('length', Object.entries(aggregateSet[keyPair.key]).length, aggregateSet[keyPair.key])
    //    console.log(keyPair)
    ...
    const aggregateZoneStats = (data) => {
       ...
       delete(aggregateSet.city)
        for (let i=1; i < data.length; i++) {
            ...
            if (aggregateSet[keyPair.key] !== undefine && keyPair.value !== undefined)
