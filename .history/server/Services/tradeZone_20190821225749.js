...
const methods = {
    ...
    const getZoneStats = async (points, callback) => {
        ...
        for (let point of points) {
            getCitySDKStats('age', point.lat, point.lng, (ageData) => {
                getCitySDKStats('income', point.lat, point.lng, (incomeData) => {
                    getCitySDKStats('social', point.lat, point.lng, (socialData) => {
