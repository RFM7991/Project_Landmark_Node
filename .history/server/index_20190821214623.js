...
if (cluster.isMaster) {
 ...
 //getTradeZoneStats
 app.get('/api/tradezone/stats/basic/:lat/:lng/', async (req, res) => {
  let center = {}
...
app.get('/api/tradezone/stats/age/:lat/:lng/', async (req, res) => {
  let center = {}
  center.lat = req.params.lat
  center.lng = req.params.lng
...
app.get('/api/tradezone/stats/social/:lat/:lng/', async (req, res) => {
  let center = {}
  center.lat = req.params.lat
  center.lng = req.params.lng
...
app.get('/api/tradezone/stats/income/:lat/:lng/', async (req, res) => {
  let center = {}
  center.lat = req.params.lat
  center.lng = req.params.lng
